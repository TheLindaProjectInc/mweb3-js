...
class Mweb3 {
   ...
   * @param {string} urlString URL of the blockchain API. eg. http://metrix:metrix@127.0.0.1:33851
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated Metrix to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Metrix address.
   * @param {string} address Metrix address
  ...
  /**
   * Converts a hex address to Metrix address.
   * @param {string} hexAddress Metrix address in hex format.
   * @return {Promise} Metrix address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Metrix address.
   * @param {string} address Metrix address to validate.
   ...
   * @param {string} address The Metrix address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the Metrix server.
  ...
  /**
   * Gets the account name associated with the Metrix address.
   * @param {string} address The Metrix address for account lookup.
  ...
  /**
   * Gets the Metrix address based on the account name.
  ...
  /**
   * Gets the Metrix address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Metrix address array or Error.
   */
  ...
  /**
   * Gets a new Metrix address for receiving payments.
   ...
   * @return {Promise} Array of addresses with MRX balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send MRX to.
   * @param {number} amount Amount of MRX to send.
   ...
   * @param {string} senderAddress The MRX address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in MRX/kB.
